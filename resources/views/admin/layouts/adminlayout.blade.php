          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('admin.showReservations')}}">Ver Reservaciones</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Usuarios</a>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('admin.showEmployees')}}">Ver usuarios</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Mesas</a>
                <div class="dropdown-menu">
                <a class="dropdown-item" href="{{route('admin.showTables')}}">ver mesas</a>
                  <a class="dropdown-item" href="{{route('admin.showAvailableTables')}}">ver mesas disponibles</a>
  
                  <a class="dropdown-item" href="{{route('admin.newTable')}}">Añadir mesa</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Perfil</a>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('admin.showProfile')}}">Ver perfil</a>
                  <a class="dropdown-item" href="{{route('admin.editProfile')}}">Editar perfil</a>
                  <a class="dropdown-item" href="{{route('admin.editPassword')}}">Cambiar contraseña</a>
