        ...
        <div class="collapse navbar-collapse nav-holders" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="{{route('employee.home')}}">Inicio <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('employee.Reservations')}}">Ver Reservaciones</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Mesas</a>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('employee.showAvailableTables')}}">ver mesas disponibles</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('employee.showProfile')}}">Ver perfil</a>
                  <a class="dropdown-item" href="{{route('employee.editProfile')}}">Editar perfil</a>
                  <a class="dropdown-item" href="{{route('employee.editPassword')}}">Cambiar contraseña</a>
                  <div class="dropdown-divider"></div>
