...
<?php $__env->startSection('title', 'Admin Perfil'); ?>
        ...
        <!-- <form method="post" enctype="multipart/form-data"> -->
            <div class="row">
                <div class="col-md-8">
                      ...
                      <a href="<?php echo e(route('admin.editProfile')); ?>" type="button" class="btn">Editar perfil</a>
                    <?php if($errors->any()): ?>
                    <ul>
...
<?php echo $__env->make('admin.layouts.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\log_in\resources\views/admin/profile/show.blade.php ENDPATH**/ ?>